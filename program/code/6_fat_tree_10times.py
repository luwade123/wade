...
dst_path='dst2.txt'
dst_num = 18
file_name = '6_fat_tree_algo_with_new_bar.txt'
f1 = open(file_name,'w')
for top_k in range(3):
    for d_w in range(4):
        ...
        #     print("number",i,"average are: ",bar_store_list[i]/bar_counting[i],"total flow",bar_counting[i]," ") 
...
for index, switch in enumerate(link_list):
    ...
    print("6_algo_switch_",index,"=",tmp,file = f1)

print(switch_flow,file=f1)