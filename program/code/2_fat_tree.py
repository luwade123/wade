...
k = 5
switch_list = [t0,t1,a0,a1,c0]
sketch_list = [sketch_t0,sketch_t1,sketch_a0,sketch_a1,sketch_c0]
...
dijk_list[0][2] = 1
dijk_list[2][0] = 1     ## t0 a0
dijk_list[0][3] = 1
dijk_list[3][0] = 1     ## t0 a1

dijk_list[1][2] = 1
dijk_list[2][1] = 1     ## t1 a0
dijk_list[1][3] = 1
dijk_list[3][1] = 1     ## t1 a1

dijk_list[2][4] = 1
dijk_list[4][2] = 1     ## a0 c0

dijk_list[3][4] = 1
dijk_list[4][3] = 1     ## a1 c0
...
def find_switch(ID):
    ...
    for i in range(len(old_path)-1):
        tmp = k_shortest_path_return_list(old_path[i],old_path[i+1],k)
        k_path.append(tmp)
    which_path = -1
