...
for top_k in range(3):
    for d_w in range(4):
        ...
        for ten_times in range(test_time):
            ...
            print(d,w)
            print(asizeof.asizeof(sketch_a0))
            ...
            def Algo():
                ...
                #         print('oringinal Put',which_flow,'into the switch',(which_switch2),"collision = ",num_to_sketch(which_switch2).query(which_flow),"MIN",MIN)                
                    ...
                    if(which_switch !=-1):
                        ...
                        print("link_mid",link_list)
                        add_the_link_cost(choose_path)
                        print("link,after",link_list)
        ...
        for index, switch in enumerate(link_list):
            ...
            print("4_algo_switch_",index,"=",tmp,file = f1)
        ...
        print("switch_ARE",ave_list,file=f1)