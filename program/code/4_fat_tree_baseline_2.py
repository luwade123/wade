...
dst_path='dst2.txt'
dst_num = 8
file_name = '4_fat_tree_baseline2_with_all_situation_dst=4.txt'
f1 = open(file_name,'w')
for top_k in range(3):
    for d_w in range(4):
        ...
        for i in range(round(len(trimmean_list))):
        ...
        for index, switch in enumerate(link_list):
            ...
            print("4_baseline2_switch_",index,"=",tmp,file = f1)
