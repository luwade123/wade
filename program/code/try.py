...
# sketch_t8 = CountMinSketch(3, 5)
# sketch_t9 = CountMinSketch(3, 5)
# sketch_t10 = CountMinSketch(3, 5)
# sketch_t11 = CountMinSketch(3, 5)
# sketch_t12 = CountMinSketch(3, 5)
# sketch_t13 = CountMinSketch(3, 5)
# sketch_t14 = CountMinSketch(3, 5)
# sketch_t15 = CountMinSketch(3, 5)
# sketch_t16 = CountMinSketch(3, 5)
# sketch_t17 = CountMinSketch(3, 5)
...
# sketch_a8 = CountMinSketch(3, 5)
# sketch_a9 = CountMinSketch(3, 5)
# sketch_a10 = CountMinSketch(3, 5)
# sketch_a11 = CountMinSketch(3, 5)
# sketch_a12 = CountMinSketch(3, 5)
# sketch_a13 = CountMinSketch(3, 5)
# sketch_a14 = CountMinSketch(3, 5)
# sketch_a15 = CountMinSketch(3, 5)
# sketch_a16 = CountMinSketch(3, 5)
# sketch_a17 = CountMinSketch(3, 5)

# sketch_c0 = CountMinSketch(3, 5)
# sketch_c1 = CountMinSketch(3, 5)
# sketch_c2 = CountMinSketch(3, 5)
# sketch_c3 = CountMinSketch(3, 5)
# sketch_c4 = CountMinSketch(3, 5)
# sketch_c5 = CountMinSketch(3, 5)
# sketch_c6 = CountMinSketch(3, 5)
# sketch_c7 = CountMinSketch(3, 5)
# sketch_c8 = CountMinSketch(3, 5)
# k_number = 8
...
#                         dijk_list_tmp[sp[time][i]][j[j.index(sp[time][i])+1]] += 90
#                         dijk_list_tmp[j[j.index(sp[time][i])+1]][sp[time][i]] += 90
...
#                 end = (end+1)%18
#                 tmp2 = int(routing[dst]) + 1
#                 new_routing[dst] = str(tmp2)
#             else:
...
a = [9, 14, 7, 9, 12, 14, 13, 11, 14, 11, 11, 11, 10, 14, 14, 16, 13, 11, 13, 12]
b = [6, 10, 9, 13, 12, 14, 9, 11, 14, 10, 12, 11, 13, 14, 17, 13, 13, 12, 12, 14]
sum = 0 
sum_b = 0
for i in a:
    sum+= i
...
# tmp2 = sorted(test_dict.items(), key=lambda x:x[1])
# tmp3 = test_dict
# print(len(tmp2))
# print(tmp2[0][0])
# del tmp3['a']
# print(tmp3)
# print(test_dict)
# print(stats.trim_mean(tmp,0.05))